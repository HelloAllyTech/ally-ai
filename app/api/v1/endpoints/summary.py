...
from app.schemas.summary import SummaryNoteAndTagsRequest, SummaryNoteAndTagsResponse, DynamicSummaryNoteResponse, \
    ContentEnhanceResponse, ContentEnhanceRequest, TagPositivityRatingRequest, TagPositivityRatingResponse
from app.utils.common import convert_chat_messages_to_string

router = APIRouter()


@router.post("/note", tags=["note", "summary"],
