...
class AnalyzeResponse(BaseModel):
    nudge: Optional[str] = Field(
        None,
        description="The generated nudge. Will be non-null if `generate_nudge` is "
        "True.",
    )
    stage: str = Field(
        ...
        json_schema_extra = {
            "example": {
                "chat_history": [
                    ...
                    {
                        "role": "speaker1",
                        "content": "Can you tell me more about what's causing this "
                        "anxiety?",
                    },
                    {
                        "role": "speaker0",
                        "content": "I'm not sure, it just started this morning",
                    },
                ]
            }
        }
